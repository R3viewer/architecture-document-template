...
image::resources/diagrams/general-application-design.svg[General application architecture diagram]
...
====
image::resources/diagrams/detailed-application-architecture-static.svg[Detailed application architecture diagram (static view)] 
...
image::resources/diagrams/detailed-application-architecture-dynamic.svg[Detailed application architecture diagram (dynamic view)] 
